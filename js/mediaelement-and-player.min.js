...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        ...
        buildtracks: function(b, c, d, e) {
            if (0 !== b.tracks.length) {
                ...
                for (g.options.toggleCaptionsButtonWhenOnlyOne && 1 == i ? b.captionsButton.on("click", function() {
                    ...
                    setTimeout(function() {
                    	a(a(e.currentTarget).find(".mejs-captions-selector").find("input[type=radio]")[0]).focus();
                	}, 250);
                }).on("click keyup", "input[type=radio]", function(e) {
                	e.stopPropagation();
                	if (e.type==="keyup" && (e.which!==32&&e.which!==13)) return;
                	a(this).parents(".mejs-captions-selector").find("input[type=radio]").prop("checked", false);
        ...
        addTrackButton: function(b, c) {
            var d = this;
            "" === c && (c = mejs.language.codes[b] || b),
            d.captionsButton.find("ul").append(a('<li><input type="radio" name="' + d.id + "_captions_" + b + ' id="' + d.id + "_captions_" + b + '" value="' + b + '" disabled="disabled" /><label for="' + d.id + "_captions_" + b + '">' + c + " (loading)</label></li>")),
            d.adjustLanguageBox(),
